...
<p align="center">
    Click on the image below to go towards the <u>bugs tracker</u> in order to explain the issues to find:<br>
...
<p align="center">
    Click on the image below to go towards the <u>wiki</u> in order to read the help online:<br>
